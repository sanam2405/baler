...
data = pd.read_csv('train_emissions.csv')
...
columns_to_scale = ['duration', 'emissions', 'emissions_rate', 'cpu_power', 'gpu_power', 'ram_power',
...
plt.title('Time Series Train: Duration vs Timestamp')
...
plt.axvline(emissions_central['50%'], color='orange', linestyle='--', label='Median (50%)')
plt.axvline(emissions_central['25%'], color='green', linestyle='--', label='Q1 (25%)')
plt.axvline(emissions_central['75%'], color='blue', linestyle='--', label='Q3 (75%)')
plt.xlabel('Emissions')
plt.title('Histogram Train: Emissions')
plt.legend()

# Emissions Rate
plt.subplot(2, 3, 2)
sns.histplot(data['emissions_rate'], bins=20, kde=True, color='salmon')
plt.axvline(emissions_rate_central['mean'], color='red', linestyle='--', label='Mean')
plt.axvline(emissions_rate_central['50%'], color='orange', linestyle='--', label='Median (50%)')
plt.axvline(emissions_rate_central['25%'], color='green', linestyle='--', label='Q1 (25%)')
plt.axvline(emissions_rate_central['75%'], color='blue', linestyle='--', label='Q3 (75%)')
plt.xlabel('Emissions Rate')
plt.title('Histogram Train: Emissions Rate')
plt.legend()
...
plt.axvline(ram_power_central['50%'], color='orange', linestyle='--', label='Median (50%)')
plt.axvline(ram_power_central['25%'], color='green', linestyle='--', label='Q1 (25%)')
plt.axvline(ram_power_central['75%'], color='blue', linestyle='--', label='Q3 (75%)')
plt.xlabel('RAM Power')
plt.title('Histogram Train: RAM Power')
plt.legend()
...
plt.axvline(cpu_energy_central['50%'], color='orange', linestyle='--', label='Median (50%)')
plt.axvline(cpu_energy_central['25%'], color='green', linestyle='--', label='Q1 (25%)')
plt.axvline(cpu_energy_central['75%'], color='blue', linestyle='--', label='Q3 (75%)')
plt.xlabel('CPU Energy')
plt.title('Histogram Train: CPU Energy')
plt.legend()
...
plt.axvline(ram_energy_central['50%'], color='orange', linestyle='--', label='Median (50%)')
plt.axvline(ram_energy_central['25%'], color='green', linestyle='--', label='Q1 (25%)')
plt.axvline(ram_energy_central['75%'], color='blue', linestyle='--', label='Q3 (75%)')
plt.xlabel('RAM Energy')
plt.title('Histogram Train: RAM Energy')
plt.legend()

# Energy Consumed
plt.subplot(2, 3, 6)
sns.histplot(data['energy_consumed'], bins=20, kde=True, color='lightyellow')
plt.axvline(energy_consumed_central['mean'], color='red', linestyle='--', label='Mean')
plt.axvline(energy_consumed_central['50%'], color='orange', linestyle='--', label='Median (50%)')
plt.axvline(energy_consumed_central['25%'], color='green', linestyle='--', label='Q1 (25%)')
plt.axvline(energy_consumed_central['75%'], color='blue', linestyle='--', label='Q3 (75%)')
plt.xlabel('Energy Consumed')
plt.title('Histogram Train: Energy Consumed')
plt.legend()
